...
- **Documentation Reorganization**: Comprehensive restructuring of `docs/` folder (392 files)
  ...
  - Organized file_reviews/ (324 files) into code-reviews/2025-10/ by module (strategy_v2, portfolio_v2, execution_v2, shared, orchestration)
  ...
  - Generated index-by-file.md for easy file lookup
  ...
  - All internal documentation links updated to new paths
