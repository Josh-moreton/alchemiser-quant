...
This module implements the full logic for the Nuclear Energy trading strategy, including:
- Market regime detection (bull/bear) using SPY and technical indicators
- Hierarchical signal generation with multi-layered RSI triggers
- Dynamic portfolio construction of nuclear energy stocks in bull markets (top 3 by momentum, inverse volatility weighting)
- Defensive rotation to tech, bonds, and volatility hedges in bear markets
- Portfolio allocation, technical indicator calculation, and alert generation
- Integration with S3 logging, alert service, and continuous/one-shot execution

This file is the main engine for all nuclear strategy analysis, portfolio allocation, and signal output.
"""
