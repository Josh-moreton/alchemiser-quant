...
**Files**: `layers/shared/the_alchemiser/shared/repositories/dynamodb_trade_ledger_repository.py`
...
**Generated by**: `layers/shared/the_alchemiser/shared/schemas/strategy_lot.py:282-283` - keys are written to every LOT item.
