...
def test_progressive_limit_orders():
    ...
    try:
        ...
        order_manager = SmartExecution(
            data_provider.trading_client, data_provider, ignore_market_hours=True
        )
        ...
        if quote and len(quote) >= 2:
            ...
            console.print("[dim]Current Market Data:[/dim]")
            ...
            console.print("  Final: Market Order")
        ...
        order_id = order_manager.place_order(symbol=test_symbol, qty=test_qty, side=OrderSide.BUY)
        ...
        console.print("✓ Starts at midpoint for best execution")
        console.print("✓ Progressive steps toward less favorable price")
        console.print("✓ 10-second timeouts with WebSocket notifications")
        console.print("✓ Market order fallback ensures execution")
        console.print("✓ Optimized for both speed and price improvement")
