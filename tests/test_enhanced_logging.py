...
class TestStructuredLogging:
    ...
    def test_structured_formatter_with_context(self):
        ...
        # Add extra fields
        record.extra_fields = {"symbol": "AAPL", "quantity": 100, "price": 150.25}
...
class TestLoggingSetup:
    ...
    def test_basic_logging_setup(self):
        ...
        with tempfile.NamedTemporaryFile(mode="w", delete=False) as tmp_file:
            try:
                setup_logging(
                    log_level=logging.INFO, log_file=tmp_file.name, structured_format=False
                )
    ...
    def test_structured_logging_setup(self):
        ...
        with tempfile.NamedTemporaryFile(mode="w", delete=False) as tmp_file:
            try:
                setup_logging(
                    log_level=logging.INFO, log_file=tmp_file.name, structured_format=True
                )
    ...
    def test_production_logging_configuration(self):
        ...
        with tempfile.NamedTemporaryFile(mode="w", delete=False) as tmp_file:
            try:
                configure_production_logging(log_level=logging.INFO, log_file=tmp_file.name)
...
class TestContextLogging:
    ...
    def test_log_with_context(self):
        ...
        log_with_context(
            logger, logging.INFO, "Order placed", symbol="AAPL", quantity=100, price=150.25
        )
    ...
    def test_log_trade_event(self):
        ...
        log_trade_event(
            logger, "order_placed", "AAPL", quantity=100, price=150.25, order_type="market"
        )
    ...
    def test_log_error_with_context(self):
        ...
        log_error_with_context(logger, error, "order_placement", symbol="AAPL", quantity=100)
...
class TestCustomExceptions:
    ...
    def test_order_execution_error_with_context(self):
        ...
        error = OrderExecutionError("Order failed", symbol="AAPL", order_type="market")
    ...
    def test_file_operation_error(self):
        ...
        error = FileOperationError(
            "File not found", file_path="/path/to/file.txt", operation="read"
        )
