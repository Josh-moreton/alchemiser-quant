...
class TestPortfolioManagementFacade:
    ...
    def test_get_current_positions(self):
        ...
        mock_trading_manager.get_all_positions.return_value = [
            mock_position1, mock_position2, mock_position3
        ]
    ...
    def test_execute_rebalancing_with_validation_failure(self):
        ...
        validation_result = {
            "is_valid": False,
            "issues": ["Insufficient buying power"]
        }
    ...
    def test_get_complete_portfolio_overview_without_targets(self):
        ...
        facade.analysis_service.get_comprehensive_portfolio_analysis = Mock(return_value=portfolio_analysis)
        facade.analysis_service.get_strategy_performance_analysis = Mock(return_value=strategy_performance)
    ...
    def test_get_complete_portfolio_overview_with_targets(self):
        ...
        facade.analysis_service.compare_target_vs_current_strategy_allocation = Mock(return_value={})
