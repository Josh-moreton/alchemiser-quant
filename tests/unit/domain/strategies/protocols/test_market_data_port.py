...
class TestMarketDataImplementation:
    ...
    def get_data(self, symbol: str, timeframe: str = "1day", period: str = "1y", **kwargs) -> pd.DataFrame:
...
class TestMarketDataPort:
    ...
    def test_protocol_import(self):
        ...
        from the_alchemiser.domain.strategies.protocols.market_data_port import MarketDataPort as ImportedPort
