...
def test_yaml_config_loading():
    ...
    print(f"✅ Symbol lists loaded correctly")
    ...
    print(f"✅ Spread thresholds loaded correctly")
    ...
    expected_keys = [
        'enabled', 'execution_mode', 'max_slippage_bps', 'aggressive_timeout_seconds',
        'max_repegs', 'leveraged_etf_count', 'high_volume_etf_count',
