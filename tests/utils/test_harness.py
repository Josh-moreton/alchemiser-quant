...
class DslTestHarness:
    ...
    def evaluate_strategy(
        ...
        return DslTestResult(
            ...
            evaluation_events=self.event_recorder.get_events_by_type("StrategyEvaluated"),
            allocation_events=self.event_recorder.get_events_by_type("PortfolioAllocationProduced"),
            correlation_id=correlation_id,
            strategy_id=strategy_id
        )
    ...
    def inject_market_conditions(self, conditions: dict[str, Any]) -> None:
        ...
        if "indicator_overrides" in conditions:
            for (symbol, indicator_type, params), value in conditions["indicator_overrides"].items():
                ...
                self.mock_market_data._indicator_cache[cache_key] = TechnicalIndicatorDTO(
                    symbol=symbol,
...
class MockIndicatorService:
    ...
    def compute_indicator(
        ...
        indicator_dto = self.market_data_service.get_indicator(symbol, indicator_type, params)
