...
class StrategyParityTestBase(ABC):
    ...
    def assert_decimal_tolerance(self, 
                                actual: Decimal, 
                                expected: Decimal, 
    ...
    def assert_float_tolerance(self, 
                              actual: float, 
                              expected: float, 
    ...
    def test_flag_switching_basic_functionality(self,
                                               mock_legacy_data_provider: Mock,
                                               mock_market_data_port: Mock) -> None:
...
class StrategySignalComparator:
    ...
    @staticmethod
    def assert_basic_signal_equivalence(legacy_symbol: str,
                                       legacy_action: str,
                                       legacy_reasoning: str,
                                       typed_symbol: str,
                                       typed_action: str,
                                       typed_reasoning: str) -> None:
    ...
    @staticmethod
    def assert_portfolio_allocation_equivalence(legacy_allocation: dict | str,
                                              typed_symbol: str,
                                              typed_allocation: Decimal) -> None:
        ...
        if isinstance(legacy_allocation, dict):
            ...
            primary_symbol = max(legacy_allocation.keys(), 
                               key=lambda s: legacy_allocation[s])
