...
class TestTradingSystemWorkflow:
    ...
    def test_trading_execution_with_mocked_dependencies(self, mock_container_factory, mock_orchestrator_init):
        ...
        with patch.object(trading_system, 'execute_trading') as mock_execute:
            mock_execute.return_value = type('TradeRunResult', (), {
                'success': True,
                'trades_executed': 2,
    ...
    def test_event_driven_workflow_with_mock_handlers(self, mock_container):
        ...
        event_bus.subscribe_global(type('MockHandler', (), {
    ...
    def test_error_handling_in_workflow(self, mock_container):
        ...
        failing_strategy_handler = type('FailingHandler', (), {
