...
class TestNuclearStrategyEngine(unittest.TestCase):
    ...
    def create_evaluation_context(self, mock_data_provider, indicators, market_data=None):
        ...
        from the_alchemiser.core.trading.nuclear_signals import (
            NuclearStrategyEngine as StrategyEngine,
        )
    ...
    def test_vox_overbought_xlf_extreme_uvxy(self):
        ...
        with patch(
            "the_alchemiser.core.trading.strategy_engine.VoxOverboughtStrategy"
        ) as mock_strategy:
            mock_instance = Mock()
            mock_instance.recommend.return_value = (
                "UVXY",
                ActionType.BUY.value,
                "XLF extremely overbought (RSI > 81)",
            )
    ...
    def test_vox_overbought_xlf_normal_hedge_portfolio(self):
        ...
        with patch(
            ...
            mock_instance.recommend.return_value = (
                "UVXY_BTAL_PORTFOLIO",
                ActionType.BUY.value,
                "VOX overbought (79-81), UVXY 75% + BTAL 25% allocation",
            )
            mock_strategy.return_value = mock_instance
    ...
    def test_bull_market_nuclear_portfolio_allocation(self):
        ...
        with patch(
            "the_alchemiser.core.trading.strategy_engine.BullMarketStrategy"
        ) as mock_strategy:
            mock_instance = Mock()
            mock_instance.recommend.return_value = (
                "NUCLEAR_PORTFOLIO",
    ...
    def test_bear_market_strategy_activation(self):
        ...
        with patch(
            "the_alchemiser.core.trading.strategy_engine.BearMarketStrategy"
        ) as mock_strategy:
            mock_instance = Mock()
            mock_instance.recommend.return_value = (
                "BEAR_PORTFOLIO",
    ...
    def test_nuclear_portfolio_missing_stocks_handling(self):
        ...
        minimal_indicators = {"SMR": {"ma_return_90": 12.0}, "BWXT": {"ma_return_90": 15.0}}
    ...
    def test_bear_strategies_same_symbol_no_portfolio(self):
        ...
        if combined:
            ...
            self.assertAlmostEqual(
                combined["SQQQ"]["weight"], 0.5, places=1
            )  # Gets 50% weight (half from each)
    ...
    def test_missing_spy_data_fallback(self):
        ...
        minimal_indicators = {"TQQQ": {"rsi_10": 50.0}}
