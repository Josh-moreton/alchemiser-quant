...
class TestNuclearStrategyEngine(unittest.TestCase):
    ...
    def test_vox_overbought_check(self):
        ...
        with patch('the_alchemiser.core.trading.nuclear_trading_bot.VoxOverboughtStrategy') as mock_strategy:
            mock_instance = Mock()
            mock_instance.recommend.return_value = ('UVXY', ActionType.BUY.value, 'VOX overbought strategy')
    ...
    def test_bull_market_nuclear_portfolio(self):
        ...
        with patch('the_alchemiser.core.trading.nuclear_trading_bot.BullMarketStrategy') as mock_strategy:
            mock_instance = Mock()
    ...
    def test_bear_market_strategy(self):
        ...
        with patch('the_alchemiser.core.trading.nuclear_trading_bot.BearMarketStrategy') as mock_strategy:
            mock_instance = Mock()
    ...
    def test_nuclear_portfolio_inverse_volatility(self):
        ...
        mock_market_data = {
            ...
            'BWXT': pd.DataFrame({
                'Close': [50, 51, 49, 50.5, 52, 48, 50] * 20   # Low volatility
            }),
            'SMR': pd.DataFrame({
                'Close': [75, 78, 72, 76, 80, 70, 75] * 20     # Medium volatility
            })
        }
    ...
    def setUp(self):
        ...
        self.base_indicators = {
            'SPY': {
                'rsi_10': 50.0,
                'ma_200': 400.0,
                'current_price': 420.0  # Bull market default
            },
            'TQQQ': {'rsi_10': 50.0},
            'SPXL': {'rsi_10': 50.0},
            'XLK': {'rsi_10': 50.0},
...
class TestStrategyEngineEdgeCases(unittest.TestCase):
    ...
    def test_nuclear_portfolio_no_nuclear_stocks(self):
        ...
        engine = NuclearStrategyEngine()
        indicators = {
            'SPY': {'rsi_10': 50.0, 'ma_return_90': 5.0}
        }
