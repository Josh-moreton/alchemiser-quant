...
class TestTradingScenarios:
    ...
    def test_tax_loss_harvesting_scenario(self):
        ...
        positions_with_pnl = {
            "AAPL": {"value": Decimal("20000.00"), "unrealized_pnl": Decimal("5000.00")},   # Gain
            "MSFT": {"value": Decimal("15000.00"), "unrealized_pnl": Decimal("-2000.00")}, # Loss
            "GOOGL": {"value": Decimal("18000.00"), "unrealized_pnl": Decimal("3000.00")}, # Gain
            "AMZN": {"value": Decimal("12000.00"), "unrealized_pnl": Decimal("-3000.00")}, # Loss
            "TSLA": {"value": Decimal("10000.00"), "unrealized_pnl": Decimal("-5000.00")}, # Loss
