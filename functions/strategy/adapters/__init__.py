...
from adapters.feature_pipeline import FeaturePipeline
...
def __getattr__(name: str) -> object:
    ...
    if name == "MarketDataProvider":
        from adapters.market_data_adapter import MarketDataProvider
    ...
    if name == "S3MarketDataAdapter":
        from adapters.s3_market_data_adapter import S3MarketDataAdapter
