...
- WorkflowFailed: Workflow failure event
- WorkflowCompleted: Workflow completion event
"""
...
class HedgeEvaluationRequested(BaseEvent):
    ...
    Triggered by AllTradesCompleted event to evaluate current portfolio exposure
