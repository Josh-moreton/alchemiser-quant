;; Filterable Group: LABU LABD Mean Reversion [FTL Copy] w/ WAM Updated Package
...
(defsymphony
 "LABU LABD Mean Reversion [FTL Copy]"
        ...
        [(group
          ...
          [(weight-equal
            [(if
              ...
              [(asset "LABU" "Direxion Daily S&P Biotech Bull 3X Shares")]
              [(asset "LABD" "Direxion Daily S&P Biotech Bear 3X Shares")])])])]
        [(group
