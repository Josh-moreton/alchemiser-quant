;; Filterable Group: WYLD Mean Reversion Combo v2 w/ Overcompensating Frontrunner [FTL]
...
;; Contains inner filter: (moving-average-return {:window 10}) (select-bottom 1) on 3 mean reversion sub-groups
(defsymphony
                                                ...
                                                [(filter
                                                  ...
                                                  [(asset "TQQQ" nil)
                                                   ...
                                                   (asset
                                                    ...
                                                    nil)])])])])])])])])])])])])])])])])])])])
             (group
              "LABU LABD Mean Reversion [FTL Copy] w/ WAM Updated Package"
              [(weight-equal
                [(if
                  (> (cumulative-return "XBI" {:window 5}) 10)
                  [(group
                    "Bullish Mean Reversion"
                    [(weight-equal
                      [(if
                        (< (cumulative-return "XBI" {:window 1}) -2)
                        [(asset
                          "LABU"
                                                ...
                                                [(filter
                                                  ...
                                                  [(asset "TQQQ" nil)
                                                   ...
                                                   (asset
                                                    ...
                                                    nil)])])])])])])])])])])])])])])])])])])])
             (group
              "DRV DRN Mean Reversion [FTL Copy] w/ WAM Updated Package"
              [(weight-equal
                [(if
                  (> (cumulative-return "IYR" {:window 5}) 10)
                  [(group
                    "Bullish Mean Reversion"
                    [(weight-equal
                      [(if
                        (< (cumulative-return "IYR" {:window 1}) -2)
                        [(asset
                          "DRN"
                          "Direxion Daily Real Estate Bull 3x Shares")]
                        [(asset
