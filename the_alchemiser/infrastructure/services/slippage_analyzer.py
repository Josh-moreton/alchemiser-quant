...
This analyzer integrates with the order lifecycle to capture execution data
and provide detailed slippage analysis for trading performance evaluation.
"""
...
class SlippageAnalysis:
    ...
    slippage_dollars: Decimal  # Slippage in dollar amount
    is_favorable: bool  # True if execution was better than intended
...
class SlippageAnalyzer:
    ...
    def record_intended_execution(
        ...
        """
        self._intended_prices[order_id] = {
            "symbol": symbol,
            "side": side,
