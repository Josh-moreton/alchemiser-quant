...
Alpaca Gateway for Infrastructure Layer.

Moved from application/trading/alpaca_client.py to properly separate infrastructure
concerns. This gateway provides Alpaca-specific implementations of trading operations
while maintaining clean separation from application and domain layers.
...
class AlpacaGateway:
    """Infrastructure gateway for Alpaca API operations.
    
    Provides Alpaca-specific implementation of trading operations in the infrastructure layer.
    This gateway encapsulates all direct Alpaca API interactions and provides clean interfaces
    for the application layer to use.
    ...
    def __init__(
        ...
        """Initialize AlpacaGateway with helper modules.
