...
from the_alchemiser.execution.domain.errors import OrderError, OrderErrorCategory
...
def render_order_error(
    ...
    if show_remediation:
        from the_alchemiser.execution.domain.errors.order_error import get_remediation_hint
