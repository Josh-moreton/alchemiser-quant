...
Account operations use case for portfolio context.

Provides account summary, risk metrics, and trading validation operations
that support portfolio state management.
"""
...
class AccountOperations:
    """Account operations use case for portfolio management."""

    def __init__(self, account_repository: AccountRepository) -> None:
        """Initialize AccountOperations use case.
    ...
    def get_account_info(self) -> AccountInfo:
        """Protocol-compliant account info method for trading engine DI mode.
    ...
    def get_positions_dict(self) -> PositionsDict:
        """Protocol-compliant positions method for trading engine DI mode.
