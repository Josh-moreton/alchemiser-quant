...
Position Service - portfolio query handler for position analysis and monitoring.

This service provides type-safe position monitoring and portfolio analysis operations.
It coordinates between domain entities and infrastructure adapters to implement
portfolio-related queries with:
...
from the_alchemiser.portfolio.domain.entities.position_info import (
    PortfolioSummary,
    PositionInfo,
