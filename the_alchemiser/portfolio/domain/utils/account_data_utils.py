...
Account data utilities for portfolio context.

Pure domain functions for extracting and processing account information,
portfolio metrics, and position data without external side effects.
"""
...
def extract_comprehensive_account_data(data_provider: Any) -> AccountInfo:
    """Extract comprehensive account data from a data provider.

    Safely extracts account information from various data provider formats
    and normalizes it into the standard AccountInfo structure.

    Args:
        data_provider: Data provider object with account information

    Returns:
        AccountInfo dictionary with normalized account data
