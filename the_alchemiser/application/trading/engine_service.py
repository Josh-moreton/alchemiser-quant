...
class TradingEngine:
        ...
        class StrategyManagerBridge:
            ...
            def get_strategy_performance_summary(self) -> dict[str, Any]:
                ...
                try:
                    ...
                    from the_alchemiser.shared_kernel.infrastructure.errors.context import (
                        create_error_context,
                    )
                    from the_alchemiser.shared_kernel.infrastructure.errors.handler import (
    ...
    def execute_multi_strategy(self) -> MultiStrategyExecutionResultDTO:
        ...
        try:
            ...
            from the_alchemiser.shared_kernel.infrastructure.errors import handle_trading_error
