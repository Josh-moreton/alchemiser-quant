...
class PerformanceMetrics:
    ...
    def __str__(self) -> str:
        return (f"Return: {self.total_return:.2f}%, CAGR: {self.cagr:.2f}%, "
...
class MetricsCalculator:
    ...
    @staticmethod
    def calculate_performance_metrics(equity_curve: List[float], 
        ...
        if len(equity_curve) < 2:
            return PerformanceMetrics(
                ...
                max_drawdown=0.0, calmar_ratio=0.0, trading_days=0,
    ...
    @staticmethod
    def calculate_rolling_sharpe(equity_curve: List[float], 
                               window: int = 252,
    ...
    @staticmethod
    def calculate_monthly_returns(equity_curve: List[float], 
