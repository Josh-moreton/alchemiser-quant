...
class StrategyAdapter:
    ...
    def update_positions(self, signals: Dict[str, float], date: dt.datetime, data: Dict[str, pd.DataFrame]):
...
class NuclearStrategyAdapter(StrategyAdapter):
    ...
    def get_signals(self, date: dt.datetime, data: Dict[str, pd.DataFrame]) -> Dict[str, float]:
        ...
        available_symbols = [sym for sym in self.nuclear_symbols if sym in data and date in data[sym].index]
...
class KLMStrategyAdapter(StrategyAdapter):
    ...
    def get_signals(self, date: dt.datetime, data: Dict[str, pd.DataFrame]) -> Dict[str, float]:
        ...
        available_leveraged = [sym for sym in ['TQQQ', 'TECL', 'SPXL'] if sym in data and date in data[sym].index]
...
class MultiStrategyAdapter:
    ...
    def get_combined_signals(self, date: dt.datetime, data: Dict[str, pd.DataFrame]) -> Dict[str, float]:
