...
Technical indicators are appropriately located within this dedicated module as they
require pandas for computation. This module provides pure mathematical computations
...
class TechnicalIndicators:
    ...
    @staticmethod
    def rsi(data: pd.Series, window: int = DEFAULT_RSI_WINDOW) -> pd.Series:
