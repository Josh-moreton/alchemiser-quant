...
class NotificationService:
    ...
    def _handle_trading_notification(self, event: TradingNotificationRequested) -> None:
        ...
        try:
                ...
                try:
                    ...
                    class EventResultAdapter:
                        def __init__(self, event_data: TradingNotificationRequested) -> None:
                            self.success = True
                            self.orders_executed: list[Any] = []  # Event data doesn't have detailed order info
                            self.strategy_signals: dict[str, Any] = {}  # Event data doesn't have signal details
            ...
            if success:
                self.logger.info(f"Trading notification sent successfully (success={event.trading_success})")
            else:
