...
class GenerateSignalsUseCase:
    ...
    def execute(self, symbols: Sequence[Symbol]) -> Sequence[SignalContractV1]:
        ...
        for symbol in symbols:
            ...
            ):  # TODO: Replace hardcoded threshold with configurable parameter
    ...
    def _calculate_simple_signal(
        self, latest_bar: MarketBarVO, history: Sequence[MarketBarVO]
    ) -> float:
    ...
    def _create_signal_contract(self, symbol: Symbol, strength: float) -> SignalContractV1:
        ...
        return SignalContractV1(
            ...
            target_allocation=Percentage(
                Decimal(str(abs(strength) * 0.1))
            ),  # TODO: Replace hardcoded 10% max with configurable parameter
