...
class TradingEngine:
    ...
    def rebalance_portfolio(
        ...
        try:
            ...
            logging.error(f"TradingEngine.rebalance_portfolio: Error running orchestrator: {e}")
            logging.error(f"TradingEngine.rebalance_portfolio: Falling back to empty orders list")
            return []
