...
Alpaca broker adapter - centralized client management for execution infrastructure.

This module provides the primary Alpaca API integration implementing domain interfaces
for trading, market data, and account operations. It serves as the infrastructure
adapter in the execution bounded context, handling all external broker interactions.

Features:
- Implements TradingRepository, MarketDataRepository, and AccountRepository interfaces
- Consistent error handling and logging
- Paper and live trading support
- Raw order envelope handling for order lifecycle management
"""
