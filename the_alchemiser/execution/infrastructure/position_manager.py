...
Position Management Infrastructure - external API interaction utilities.

This module provides infrastructure adapters for position management operations,
including position validation, liquidation logic, and buying power checks.
It serves as an adapter between external broker APIs and the execution domain.
"""
