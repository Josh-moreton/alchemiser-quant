...
Order operations use case for execution context.

Provides enhanced order operations with validation and business rules for order execution.
"""
...
class OrderOperations:
    ...
    def __init__(
        ...
        """Initialize the order operations use case.
    ...
    def get_open_orders(self) -> list[dict]:
        ...
        """
        try:
            return self._trading.get_open_orders()
    ...
    def get_order_status(self, order_id: str) -> dict:
        ...
        """
        try:
            return self._trading.get_order_status(order_id)
        except Exception as e:
    ...
    def validate_order_request(
        ...
        Args:
            ...
            quantity: Number of shares (for quantity-based orders)
        ...
        if quantity is not None:
            ...
            raise OrderValidationError("Either quantity or notional must be specified")
        ...
        if order_type == OrderType.LIMIT:
            ...
            self._validate_limit_price(symbol, limit_price)

        # Validate market price for market orders
        if order_type == OrderType.MARKET:
            self._validate_market_price(symbol)

        # Validate sell orders have sufficient position
        if side == "sell":
            self._validate_sell_position(symbol, quantity)
