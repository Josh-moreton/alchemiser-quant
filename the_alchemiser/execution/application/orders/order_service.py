...
Order Service - application layer order coordination and validation.

This service provides type-safe, validated order placement operations.
It coordinates between domain entities and infrastructure adapters,
implementing order-related use cases with:
...
from the_alchemiser.execution.domain.entities.order_exceptions import (
    OrderOperationError,
    OrderValidationError,
)
from the_alchemiser.execution.domain.entities.order_type import OrderType
