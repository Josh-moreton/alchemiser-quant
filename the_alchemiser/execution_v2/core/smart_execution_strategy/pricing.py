...
class PricingCalculator:
    ...
    def _calculate_price_fundamentals(self, quote: QuoteModel) -> tuple[Decimal, Decimal, Decimal, Decimal]:
    ...
    def _calculate_buy_anchor(self, bid: Decimal, ask: Decimal, mid: Decimal, tick: Decimal) -> Decimal:
    ...
    def _calculate_sell_anchor(self, bid: Decimal, ask: Decimal, mid: Decimal, tick: Decimal) -> Decimal:
    ...
    def _build_fallback_metadata(self, bid: Decimal, ask: Decimal, mid: Decimal) -> LiquidityMetadata:
