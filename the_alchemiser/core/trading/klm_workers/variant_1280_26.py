...
class KLMVariant1280_26(BaseKLMVariant):
    ...
    def __init__(self):
        super().__init__(
            name="1280/26",
            description="KMLM (50) - Direct to Combined Pop Bot variant"
        )
    ...
    def _evaluate_combined_pop_bot_with_labu(self, indicators: Dict) -> Tuple[Union[str, Dict[str, float]], str, str]:
        """
    ...
    def _evaluate_kmlm_switcher_1280(self, indicators: Dict) -> Tuple[Union[str, Dict[str, float]], str, str]:
        """
        ...
        if 'XLK' in indicators and 'KMLM' in indicators:
            ...
            if xlk_rsi > kmlm_rsi:
                ...
                if len(candidates) >= 2:
                    ...
                    # Fallback
                    result = ('TECL', ActionType.BUY.value, "1280/26 KMLM Switcher: XLK > KMLM → TECL fallback")
    ...
    def get_required_symbols(self) -> list:
        ...
        overbought_symbols = ['QQQE', 'VTV', 'VOX', 'TECL', 'VOOG', 'VOOV', 'XLP', 'TQQQ', 'XLY', 'FAS', 'SPY', 'UVXY']
        ...
        return list(set(overbought_symbols + pop_bot_symbols + kmlm_switcher_symbols + rotator_symbols + fallback_symbols))
