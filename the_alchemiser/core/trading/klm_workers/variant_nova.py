...
class KLMVariantNova(BaseKLMVariant):
    ...
    def _evaluate_single_popped_kmlm_nova(self, indicators: Dict) -> Tuple[Union[str, Dict[str, float]], str, str]:
        """
    ...
    def _evaluate_bsc_strategy(self, indicators: Dict) -> Tuple[str, str, str]:
        ...
        if 'SPY' in indicators:
            ...
            if spy_rsi_21 > 30:
                ...
                result = ('SPXL', ActionType.BUY.value, "Nova BSC: SPY oversold (RSI(21) <= 30) → SPXL")
        else:
    ...
    def _evaluate_kmlm_switcher_nova(self, indicators: Dict) -> Tuple[Union[str, Dict[str, float]], str, str]:
        """
    ...
    def get_required_symbols(self) -> list:
        ...
        return list(set(overbought_symbols + single_popped_symbols + bsc_symbols + 
                       pop_bot_symbols + kmlm_switcher_symbols + individual_stocks + rotator_symbols))
