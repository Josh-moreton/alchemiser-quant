...
class KLMVariant520_22(BaseKLMVariant):
    ...
    def _evaluate_bsc_strategy(self, indicators: Dict) -> Tuple[str, str, str]:
        ...
        if 'SPY' in indicators:
            ...
            if spy_rsi_21 > 30:
                ...
                result = ('SPXL', ActionType.BUY.value, "520/22 BSC: SPY oversold (RSI(21) <= 30) → SPXL")
        else:
    ...
    def _evaluate_kmlm_switcher_520(self, indicators: Dict) -> Tuple[Union[str, Dict[str, float]], str, str]:
        """
