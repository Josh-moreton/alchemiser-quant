...
class KLMVariant830_21(BaseKLMVariant):
    ...
    def _evaluate_bsc_strategy(self, indicators: Dict) -> Tuple[str, str, str]:
        ...
        if 'SPY' in indicators:
            ...
            if spy_rsi_21 > 30:
                ...
                result = ('SPXL', ActionType.BUY.value, "830/21 BSC: SPY oversold (RSI(21) <= 30) → SPXL")
        else:
    ...
    def _evaluate_kmlm_switcher_830(self, indicators: Dict) -> Tuple[Union[str, Dict[str, float]], str, str]:
        """
        ...
        if 'XLK' in indicators and 'KMLM' in indicators:
            ...
            if xlk_rsi > kmlm_rsi:
                ...
                if candidates:
                    ...
                    result = (selected[0], ActionType.BUY.value, 
    ...
    def _evaluate_bond_check(self, indicators: Dict) -> Tuple[str, str, str]:
        ...
        if bnd_ma_return > 0:
            ...
            if candidates:
                ...
                result = ('KMLM', ActionType.BUY.value, "830/21 Bond Check: KMLM fallback (positive bonds)")
        else:
            ...
            if candidates:
                ...
                result = ('TLT', ActionType.BUY.value, "830/21 Bond Check: TLT fallback (negative bonds)")
    ...
    def get_required_symbols(self) -> list:
        ...
        return list(set(overbought_symbols + single_popped_symbols + bsc_symbols + 
                       pop_bot_symbols + kmlm_switcher_symbols + bond_check_symbols))
