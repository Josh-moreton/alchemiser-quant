...
def setup_logging(
    ...
    if suppress_third_party:
        noisy_loggers = [
            'botocore', 'urllib3', 'alpaca', 'boto3', 's3transfer', 
            'websocket', 'matplotlib', 'requests', 'urllib3.connectionpool',
            'werkzeug', 'asyncio'
        ]
...
def get_trading_logger(module_name: str, **context) -> Union[logging.Logger, AlchemiserLoggerAdapter]:
    """
