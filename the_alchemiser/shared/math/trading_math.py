...
def calculate_rebalance_amounts(
    ...
    for symbol in all_symbols:
        ...
        if total_portfolio_value <= 0.0 and needs_rebalance:
            ...
            logger.error("🚨 ROOT CAUSE: Portfolio value is 0 or negative, making all trades impossible")
            logger.error("🚨 FIX: Ensure portfolio value reflects cash balance for fresh accounts or fix API data fetching")
