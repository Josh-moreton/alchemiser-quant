...
def demo_strategy_to_portfolio_communication() -> dict[str, any]:
    ...
    for signal in signals:
        print(f"  - {signal.symbol}: {signal.action} (confidence: {signal.confidence}, allocation: {signal.allocation_weight})")
...
def demo_execution_feedback_communication() -> dict[str, any]:
    ...
    print(f"   Orders executed: {execution_report.successful_orders}/{execution_report.total_orders}")
