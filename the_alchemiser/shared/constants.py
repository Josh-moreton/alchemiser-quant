...
# Strategy attribution & naming (centralised to avoid magic strings)
DEFAULT_UNKNOWN_STRATEGY_NAME = "UNKNOWN_LEGACY"
DSL_STRATEGY_SOURCE = "DSL"
CONSOLIDATED_STRATEGY_SOURCE = "CONSOLIDATED"
PORTFOLIO_ANALYSIS_STRATEGY_NAME = "PORTFOLIO_ANALYSIS"
...
__all__ = [
    ...
    "CONFIDENCE_RANGE",
    "CONSOLIDATED_STRATEGY_SOURCE",
    "DECIMAL_ZERO",
    "DEFAULT_AWS_REGION",
    "DEFAULT_DATE_FORMAT",
    "DEFAULT_UNKNOWN_STRATEGY_NAME",
    "DSL_ENGINE_MODULE",
    "DSL_STRATEGY_SOURCE",
    ...
    "ORDER_TYPES",
    "PERCENTAGE_RANGE",
    "PORTFOLIO_ANALYSIS_STRATEGY_NAME",
