...
Broker-specific schemas for shared use.

This module provides schemas that can be used by shared components like AlpacaManager
...
class OrderExecutionResult(Result):
    ...
    def validate_avg_fill_price(cls, v: Decimal | None) -> Decimal | None:
        """Validate that average fill price is positive."""
