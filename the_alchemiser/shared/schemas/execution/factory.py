...
Trade result factory utilities for creating schemas.
...
from the_alchemiser.shared.schemas.execution.trade_results import (
    OrderResultSummary,
...
def create_failure_result(
    ...
    """Create a failure result schema.
...
def create_success_result(
    ...
    *,
    ...
    """Create a success result schema from trading results.
...
def _calculate_execution_summary(
    ...
    """Calculate execution summary metrics from order schemas.

    Args:
        order_dtos: List of order result schemas
        started_at: Execution start time
        completed_at: Execution completion time

    Returns:
        TradeExecutionSummary with calculated metrics
...
def _determine_execution_status(*, success: bool, execution_summary: TradeExecutionSummary) -> str:
