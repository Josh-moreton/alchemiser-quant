...
class LambdaEvent(BaseModel):
    ...
    arguments: list[str] | None = Field(
        default=None,
        description="Additional command line arguments for CLI invocation"
    )
    ...
    account_id: str | None = Field(
        default=None,
        description="Explicit account ID override for summary"
    )

    # P&L analysis fields (optional)
    pnl_type: Literal["weekly", "monthly"] | None = Field(
        default=None,
        description="P&L analysis type: 'weekly' or 'monthly'"
    )
    ...
    pnl_detailed: bool | None = Field(
        default=None,
        description="Include detailed daily breakdown in P&L analysis"
    )
    ...
    subject: str | None = Field(
        default=None,
        description="Override email subject for summary"
    )
    dry_run: bool | None = Field(
        default=None,
        description="When true, compute summary but do not send email"
    )
