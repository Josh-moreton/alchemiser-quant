(defsymphony
 ...
 (weight-specified
  0.4
  (group
   "V3| S&P risk on/off | DJKeyhole 🧙‍♂️ | Changed to V2 Advance Volatility Hedge & V1.1 A Better LETF Basket"
   [(weight-equal
     [(if
                                      ...
                                      [(weight-equal
                                        [(asset
                                         ...
                                         (asset
                                          ...
                                          "Consumer Staples Select Sector SPDR Fund")])])]))])])])])])])])])])
                (group
                 "V2.0.1 | A Better LETF Basket | DJKeyhole 🧙‍♂️ | No UGE"
                 [(weight-equal
                   [(if
                     (>
                      (current-price "TLT")
  ...
  0.6
  (group
   "V3.1.1 | A Better \"Buy the Dips LETFs\" | DJKeyhole 🧙‍♂️ | No UGE"
   [(weight-equal
     [(if
