...
from the_alchemiser.domain.strategies.errors import StrategyValidationError
...
class StrategyEngine(ABC):
    ...
    def validate_market_data_availability(self, symbols: list[str] | None = None) -> bool:
        ...
        Raises:
            StrategyValidationError: If required data is unavailable
        ...
        if unavailable_symbols:
            ...
            raise StrategyValidationError(error_msg, self.strategy_name)
