    ...
    if portfolio_history:
        ...
        if profit_loss:
            ...
            portfolio_metrics.update({
                "daily_pl": float(latest_pl),
                "daily_pl_percent": float(latest_pl_pct) * 100
            })
...
def extract_strategies_data(strategy_signals: Dict, strategy_allocations: Dict) -> Dict[str, Dict[str, Any]]:
    """
...
def extract_recent_trades_data(orders_executed: List[Dict], limit: int = 10) -> List[Dict[str, Any]]:
    """
