...
def calculate_strategy_pnl_summary(paper_trading: bool, current_prices: Dict[str, float]) -> Dict[str, Any]:
    """
...
def build_strategy_summary(strategy_signals: Dict, strategy_allocations: Dict, all_strategy_pnl: Dict) -> Dict[str, Any]:
    """
...
def build_allocation_summary(consolidated_portfolio: Dict[str, float]) -> Dict[str, Dict[str, float]]:
    """
