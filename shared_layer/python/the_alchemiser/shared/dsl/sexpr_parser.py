...
for evaluation by the DSL engine. This module lives in the shared layer so
that both the strategy worker and data-side backfill workers can parse
strategy files without duplicating code.
"""
